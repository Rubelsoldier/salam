...
<template>
    <div class="cursor-pointer bg-white transition-all border-2 border-transparent hover:border-indigo-200">
        <Link :href="route('profile', user.username)" class="flex items-center gap-2 py-2 px-2">
            <img :src="user.avatar_url || '/img/default_avatar.jpg'" class="w-[32px] rounded-full"/>
