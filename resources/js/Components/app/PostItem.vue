                        ...
                        <div class="pl-10">
                            ...
                            <div class="mt-1 flex gap-2">
                                <button @click="sendCommentReaction(comment)" 
                                        class="flex items-center text-xs text-indigo-500 py-0.5 px-1  rounded-lg hover:bg-indigo-100"
                                        :class="[
                                ...
                                <button class="flex items-center text-xs text-indigo-500  py-0.5 px-1  rounded-lg hover:bg-indigo-100">
